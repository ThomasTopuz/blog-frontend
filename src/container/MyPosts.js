...
function MyPosts() {
    ...
    useEffect(() => {
        //fetch all posts
        axios.get(BASE_URL+'/post/created', {headers: {'x-auth-token': localStorage.getItem("jwtToken")}})
            .then((res) => {
    ...
    function createPost(data) {
        axios.post(BASE_URL+'/post', data, {headers: {'x-auth-token': localStorage.getItem('jwtToken')}})
